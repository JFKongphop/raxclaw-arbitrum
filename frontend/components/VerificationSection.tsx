      ...
      <div className="section-inner">
        <div style={{ marginBottom: 52 }}>
          ...
          <p className="section-desc">
            Every audit is permanently stored on-chain via Arbitrum Stylus.
        ...
        >
          ...
          <span style={{ color: 'var(--cyan)' }}>Arbitrum Sepolia</span> and anchored
          via ERC-7857 on{' '}
          <span style={{ color: 'var(--cyan)' }}>Arbitrum Mainnet (chain 42161)</span>.
